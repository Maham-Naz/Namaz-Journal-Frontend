  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col justify-center items-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-3xl shadow-sm dark:shadow-none border border-slate-100 dark:border-slate-700 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-emerald-950 dark:text-emerald-50 mb-2">404</h1>
        <h2 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-slate-100 mb-4">Page Not Found</h2>
